...
//  pifapp
//
//  Created by srihari ponnapalli on 12/05/20.
...
class FireViewController: UIViewController {
    ...
    @IBOutlet var tenantButton: UIButton!
    @IBOutlet var nonTenantButton: UIButton!
    ...
    let mounthDataValues = [2.1, 1.2, -2.2, -1.5, -1.8]
...
extension FireViewController: IValueFormatter {
        // IValueFormatter
    ...
    extension FireViewController: IAxisValueFormatter {
        // IAxisValueFormatter
